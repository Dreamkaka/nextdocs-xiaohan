...
function Breadcrumb({
  ...
  return /* @__PURE__ */ jsx7("div", { className: "nextra-breadcrumb nx-mt-1.5 nx-flex nx-items-center nx-gap-1 nx-overflow-hidden nx-text-sm nx-text-gray-500 contrast-more:nx-text-current", children: activePath.map((item, index) => {
...
var TypeToEmoji = {
  default: "\u{1F4A1}",
  error: "\u{1F6AB}",
  info: /* @__PURE__ */ jsx8(InformationCircleIcon, { className: "nx-mt-1" }),
  warning: "\u26A0\uFE0F"
};
var classes = {
  default: cn4(
...
var classes2 = {
  cards: cn5("nextra-cards nx-mt-4 nx-gap-4 nx-grid"),
  card: cn5(
...
var arrowEl = /* @__PURE__ */ jsx9("span", { className: "nx-transition-transform nx-duration-75 group-hover:nx-translate-x-[2px]", children: "\u2192" });
function Card(_a) {
  var _b = _a, {
    children,
    title,
...
var Tree = ({ children }) => /* @__PURE__ */ jsx11("div", { className: "nx-mt-6 nx-select-none nx-text-sm nx-text-gray-800 dark:nx-text-gray-300", children: /* @__PURE__ */ jsx11("div", { className: "nx-inline-flex nx-flex-col nx-rounded-lg nx-border nx-px-4 nx-py-2 dark:nx-border-neutral-800", children }) });
function Ident() {
  const indent = useIndent();
  return /* @__PURE__ */ jsx11(Fragment3, { children: [...Array(indent)].map((_, i) => /* @__PURE__ */ jsx11("span", { className: "nx-inline-block nx-w-5" }, i)) });
}
var Folder = memo(
  ({ label, name, open, children, defaultOpen = false, onToggle }) => {
    ...
    return /* @__PURE__ */ jsxs6("li", { className: "nx-flex nx-list-none nx-flex-col", children: [
      /* @__PURE__ */ jsxs6(
        "a",
        {
          onClick: toggle,
          ...
          children: [
            /* @__PURE__ */ jsx11(Ident, {}),
            /* @__PURE__ */ jsx11("svg", { width: "1em", height: "1em", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx11(
              "path",
              {
                fill: "none",
                stroke: "currentColor",
            ...
            /* @__PURE__ */ jsx11("span", { className: "nx-ml-1", children: label != null ? label : name })
          ]
        }
      ),
      isFolderOpen && /* @__PURE__ */ jsx11("ul", { children: /* @__PURE__ */ jsx11(ctx.Provider, { value: indent + 1, children }) })
    ] });
  }
);
Folder.displayName = "Folder";
var File = memo(({ label, name, active }) => /* @__PURE__ */ jsx11(
  "li",
  {
    className: cn7(
    ...
    children: /* @__PURE__ */ jsxs6("a", { className: "nx-inline-flex nx-cursor-default nx-items-center nx-py-1", children: [
      /* @__PURE__ */ jsx11(Ident, {}),
      /* @__PURE__ */ jsx11("svg", { width: "1em", height: "1em", viewBox: "0 0 24 24", children: /* @__PURE__ */ jsx11(
        "path",
        {
...
var Input = forwardRef2(
  (_a, forwardedRef) => {
    ...
    return /* @__PURE__ */ jsxs7("div", { className: "nx-relative nx-flex nx-items-center nx-text-gray-900 contrast-more:nx-text-gray-800 dark:nx-text-gray-300 contrast-more:dark:nx-text-gray-300", children: [
      /* @__PURE__ */ jsx12(
        "input",
        __spreadValues({
          ref: forwardedRef,
...
function Search({
    ...
    Transition,
    {
      ...
      children: /* @__PURE__ */ jsx13(
        "kbd",
        {
          ...
          children: value && focused ? "ESC" : mounted && (navigator.userAgent.includes("Macintosh") ? /* @__PURE__ */ jsxs8(Fragment5, { children: [
  ...
  return /* @__PURE__ */ jsxs8("div", { className: cn9("nextra-search nx-relative md:nx-w-64", className), children: [
    renderList && /* @__PURE__ */ jsx13(
      "div",
      {
      ...
      Transition,
      {
        ...
        children: /* @__PURE__ */ jsx13(
          "ul",
          {
            ...
            children: error ? /* @__PURE__ */ jsxs8("span", { className: "nx-flex nx-select-none nx-justify-center nx-gap-2 nx-p-8 nx-text-center nx-text-sm nx-text-red-500", children: [
              /* @__PURE__ */ jsx13(InformationCircleIcon2, { className: "nx-h-5 nx-w-5" }),
              renderString(config.search.error)
            ] }) : loading ? /* @__PURE__ */ jsxs8("span", { className: "nx-flex nx-select-none nx-justify-center nx-gap-2 nx-p-8 nx-text-center nx-text-sm nx-text-gray-400", children: [
              /* @__PURE__ */ jsx13(SpinnerIcon, { className: "nx-h-5 nx-w-5 nx-animate-spin" }),
              renderComponent(config.search.loading)
            ] }) : results.length > 0 ? results.map(({ route, prefix, children, id }, i) => /* @__PURE__ */ jsxs8(Fragment4, { children: [
              prefix,
              /* @__PURE__ */ jsx13(
                "li",
                {
    ...
    while ((result = regexp.exec(value)) !== null) {
      res.push(
        /* @__PURE__ */ jsxs9(Fragment6, { children: [
          ...
          /* @__PURE__ */ jsx14("span", { className: "nx-text-primary-600", children: splitText.splice(0, regexp.lastIndex - result.index).join("") })
        ] }, id++)
      );
    ...
    for (let i = 0; i < pageResults.length; i++) {
      ...
      for (let j = 0; j < sectionResults.length; j++) {
        ...
        results2.push({
          ...
          _section_rk: j,
          route: url,
          prefix: isFirstItemOfPage && /* @__PURE__ */ jsx15(
            "div",
            {
              className: cn10(
          ...
          children: /* @__PURE__ */ jsxs10(Fragment8, { children: [
            /* @__PURE__ */ jsx15("div", { className: "nx-text-base nx-font-semibold nx-leading-5", children: /* @__PURE__ */ jsx15(HighlightMatches, { match: search2, value: title }) }),
            content && /* @__PURE__ */ jsx15("div", { className: "excerpt nx-mt-1 nx-text-sm nx-leading-[1.35rem] nx-text-gray-600 dark:nx-text-gray-400 contrast-more:dark:nx-text-gray-50", children: /* @__PURE__ */ jsx15(HighlightMatches, { match: search2, value: content }) })
          ] })
        });
...
function Select({
  ...
  return /* @__PURE__ */ jsx16(Listbox, { value: selected, onChange, children: ({ open }) => /* @__PURE__ */ jsxs11(
    Listbox.Button,
    {
      ref: trigger,
      title,
      ...
      children: [
        selected.name,
        /* @__PURE__ */ jsx16(Portal, { children: /* @__PURE__ */ jsx16(
          Transition2,
          {
            ref: container,
            show: open,
            ...
            leaveFrom: "nx-opacity-100",
            leaveTo: "nx-opacity-0",
            children: options.map((option) => /* @__PURE__ */ jsxs11(
              Listbox.Option,
              {
                value: option,
                ...
                children: [
                  option.name,
                  option.key === selected.key && /* @__PURE__ */ jsx16("span", { className: "nx-absolute nx-inset-y-0 nx-flex nx-items-center ltr:nx-right-3 rtl:nx-left-3", children: /* @__PURE__ */ jsx16(CheckIcon, {}) })
                ]
              },
              option.key
            ))
  ...
  return /* @__PURE__ */ jsx17(
    Select,
    {
      ...
      selected: {
        ...
        name: /* @__PURE__ */ jsxs12("span", { className: "nx-flex nx-items-center nx-gap-2", children: [
          /* @__PURE__ */ jsx17(GlobeIcon, {}),
          /* @__PURE__ */ jsx17("span", { className: lite ? "nx-hidden" : "", children: selected == null ? void 0 : selected.text })
        ] })
      },
...
function Footer({ menu }) {
  const config = useConfig();
  return /* @__PURE__ */ jsxs13("footer", { className: "nx-bg-gray-100 nx-pb-[env(safe-area-inset-bottom)] dark:nx-bg-neutral-900 print:nx-bg-transparent", children: [
    /* @__PURE__ */ jsxs13(
      "div",
      {
        className: cn12(
        ...
        children: [
          config.i18n.length > 0 && /* @__PURE__ */ jsx18(LocaleSwitch, { options: config.i18n }),
          config.darkMode && renderComponent(config.themeSwitch.component)
        ]
      }
    ),
    /* @__PURE__ */ jsx18("hr", { className: "dark:nx-border-neutral-800" }),
    /* @__PURE__ */ jsx18(
      "div",
      {
        className: cn12(
...
function Head() {
  ...
  return /* @__PURE__ */ jsxs14(Fragment9, { children: [
    ...
    /* @__PURE__ */ jsxs14(NextHead, { children: [
      config.faviconGlyph ? /* @__PURE__ */ jsx19(
        "link",
        {
          rel: "icon",
...
var classes3 = {
  ...
  icon: cn13("nx-inline nx-h-5 nx-shrink-0")
};
var NavLinks = ({
  flatDirectories,
  currentIndex
  ...
  return /* @__PURE__ */ jsxs15(
    "div",
    {
      ...
      children: [
        prev && /* @__PURE__ */ jsxs15(
          Anchor,
          {
            href: prev.route,
            title: prev.title,
            className: cn13(classes3.link, "ltr:nx-pr-4 rtl:nx-pl-4"),
            children: [
              /* @__PURE__ */ jsx20(ArrowRightIcon2, { className: cn13(classes3.icon, "ltr:nx-rotate-180") }),
              prev.title
            ]
          }
        ),
        next2 && /* @__PURE__ */ jsxs15(
          Anchor,
          {
            href: next2.route,
            title: next2.title,
            ...
            children: [
              next2.title,
              /* @__PURE__ */ jsx20(ArrowRightIcon2, { className: cn13(classes3.icon, "rtl:nx-rotate-180") })
            ]
          }
        )
      ]
...
var classes4 = {
  ...
  active: cn14("nx-font-medium nx-subpixel-antialiased"),
  inactive: cn14(
...
function NavbarMenu({
  ...
  return /* @__PURE__ */ jsx21("div", { className: "nx-relative nx-inline-block", children: /* @__PURE__ */ jsxs16(Menu, { children: [
    /* @__PURE__ */ jsx21(
      Menu.Button,
      {
        className: cn14(
        ...
        children: /* @__PURE__ */ jsx21(
          Menu.Items,
          {
            ...
            children: Object.entries(items || {}).map(([key, item]) => {
              var _a;
              return /* @__PURE__ */ jsx21(Menu.Item, { children: /* @__PURE__ */ jsx21(
                Anchor,
                {
...
function Navbar({ flatDirectories, items }) {
  ...
  return /* @__PURE__ */ jsxs16("div", { className: "nextra-nav-container nx-sticky nx-top-0 nx-z-20 nx-w-full nx-bg-transparent print:nx-hidden", children: [
    /* @__PURE__ */ jsx21(
      "div",
      {
        className: cn14(
    ...
    /* @__PURE__ */ jsxs16("nav", { className: "nx-mx-auto nx-flex nx-h-[var(--nextra-navbar-height)] nx-max-w-[90rem] nx-items-center nx-justify-end nx-gap-2 nx-pl-[max(env(safe-area-inset-left),1.5rem)] nx-pr-[max(env(safe-area-inset-right),1.5rem)]", children: [
      config.logoLink ? /* @__PURE__ */ jsx21(
        Anchor,
        {
      ...
      ) : /* @__PURE__ */ jsx21("div", { className: "nx-flex nx-items-center ltr:nx-mr-auto rtl:nx-ml-auto", children: renderComponent(config.logo) }),
      items.map((pageOrMenu) => {
        ...
        return /* @__PURE__ */ jsxs16(
          Anchor,
          {
            ...
            children: [
              /* @__PURE__ */ jsx21("span", { className: "nx-absolute nx-inset-x-0 nx-text-center", children: page.title }),
              /* @__PURE__ */ jsx21("span", { className: "nx-invisible nx-font-medium", children: page.title })
            ]
          },
          href
        );
      ...
      config.project.link ? /* @__PURE__ */ jsx21(
        Anchor,
        {
      ...
      config.chat.link ? /* @__PURE__ */ jsx21(
        Anchor,
        {
          className: "nx-p-2 nx-text-current",
...
import { Fragment as Fragment10, jsx as jsx24, jsxs as jsxs17 } from "react/jsx-runtime";
...
var Folder2 = memo3(function FolderInner(props) {
  ...
  return /* @__PURE__ */ jsx24(FolderLevelContext.Provider, { value: level + 1, children: /* @__PURE__ */ jsx24(FolderImpl, __spreadValues({}, props)) });
});
var classes5 = {
  link: cn15(
  ...
  list: cn15("nx-flex nx-flex-col nx-gap-1"),
  border: cn15(
...
function FolderImpl({ item, anchors }) {
  ...
  return /* @__PURE__ */ jsxs17("li", { className: cn15({ open, active }), children: [
    /* @__PURE__ */ jsxs17(
      ComponentToUse,
      {
    ...
    /* @__PURE__ */ jsx24(Collapse, { className: "ltr:nx-pr-0 rtl:nx-pl-0 nx-pt-1", isOpen: open, children: Array.isArray(item.children) ? /* @__PURE__ */ jsx24(
      Menu2,
      {
        className: cn15(classes5.border, "ltr:nx-ml-3 rtl:nx-mr-3"),
  ...
  return /* @__PURE__ */ jsx24(
    "li",
    {
      ...
      children: title ? renderComponent(config.sidebar.titleComponent, {
        ...
        type: "separator",
        route: ""
      }) : /* @__PURE__ */ jsx24("hr", { className: "nx-mx-2 nx-border-t nx-border-gray-200 dark:nx-border-primary-100/10" })
    }
  );
}
function File2({
  ...
  return /* @__PURE__ */ jsxs17("li", { className: cn15(classes5.list, { active }), children: [
    /* @__PURE__ */ jsx24(
      Anchor,
      {
        href: item.href || item.route,
        newWindow: item.newWindow,
        className: cn15(classes5.link, active ? classes5.active : classes5.inactive),
        onClick: () => {
          setMenu(false);
        },
        onFocus: () => {
    ...
    active && anchors.length > 0 && /* @__PURE__ */ jsx24(
      "ul",
      {
        className: cn15(
          classes5.list,
        ...
        children: anchors.map(({ id, value }) => {
          var _a;
          return /* @__PURE__ */ jsx24("li", { children: /* @__PURE__ */ jsx24(
            "a",
            {
              href: `#${id}`,
              className: cn15(
...
function Menu2({
  ...
  return /* @__PURE__ */ jsx24("ul", { className: cn15(classes5.list, className), children: directories.map(
    (item) => !onlyCurrentDocs || item.isUnderCurrentDocsTree ? item.type === "menu" || item.children && (item.children.length || !item.withIndexPage) ? /* @__PURE__ */ jsx24(Folder2, { item, anchors }, item.name) : /* @__PURE__ */ jsx24(File2, { item, anchors }, item.name) : null
  ) });
}
function Sidebar({
  docsDirectories,
  ...
  return /* @__PURE__ */ jsxs17(Fragment10, { children: [
    includePlaceholder && asPopover ? /* @__PURE__ */ jsx24("div", { className: "max-xl:nx-hidden nx-h-0 nx-w-64 nx-shrink-0" }) : null,
    /* @__PURE__ */ jsx24(
      "div",
      {
        className: cn15(
    ...
    /* @__PURE__ */ jsxs17(
      "aside",
      {
        ...
        ref: containerRef,
        children: [
          /* @__PURE__ */ jsx24("div", { className: "nx-px-4 nx-pt-4 md:nx-hidden", children: renderComponent(config.search.component, {
            directories: flatDirectories
          }) }),
          /* @__PURE__ */ jsx24(FocusedItemContext.Provider, { value: focused, children: /* @__PURE__ */ jsx24(
            OnFocuseItemContext.Provider,
            {
              ...
              children: /* @__PURE__ */ jsxs17(
                "div",
                {
                  ...
                  ref: sidebarRef,
                  children: [
                    (!asPopover || !showSidebar) && /* @__PURE__ */ jsx24(Collapse, { isOpen: showSidebar, horizontal: true, children: /* @__PURE__ */ jsx24(
                      Menu2,
                      {
          ...
          hasMenu && /* @__PURE__ */ jsxs17(
            "div",
            {
              className: cn15(
                ...
                showSidebar ? cn15(hasI18n && "nx-justify-end", "nx-border-t") : "nx-py-4 nx-flex-wrap nx-justify-center"
              ),
              "data-toggle-animation": showToggleAnimation ? showSidebar ? "show" : "hide" : "off",
              children: [
                hasI18n && /* @__PURE__ */ jsx24(
                  LocaleSwitch,
                  {
                    options: config.i18n,
                    lite: !showSidebar,
                    className: cn15(showSidebar ? "nx-grow" : "max-md:nx-grow")
                  }
                ),
                config.darkMode && /* @__PURE__ */ jsx24(
                  "div",
                  {
                ...
                config.sidebar.toggleButton && /* @__PURE__ */ jsx24(
                  "button",
                  {
...
var SkipNavLink = forwardRef3(
  function(_a, forwardedRef) {
    ...
    const className = providedClassName === void 0 ? styled ? cn16(
      "nx-sr-only",
...
var SkipNavContent = forwardRef3(
  function(_a, forwardedRef) {
    ...
    return /* @__PURE__ */ jsx25("div", __spreadProps(__spreadValues({}, props), { ref: forwardedRef, id: id || DEFAULT_ID }));
  }
);
...
function ThemeSwitch({
  ...
  return /* @__PURE__ */ jsx28(
    Select,
    {
      ...
      selected: {
        key: theme2,
        name: /* @__PURE__ */ jsxs19("div", { className: "nx-flex nx-items-center nx-gap-2 nx-capitalize", children: [
          /* @__PURE__ */ jsx28(IconToUse, {}),
          /* @__PURE__ */ jsx28("span", { className: lite ? "md:nx-hidden" : "", children: mounted ? options[theme2] : options.light })
        ] })
      }
    }
  );
...
function TOC({ headings, filePath }) {
  ...
  return /* @__PURE__ */ jsxs20(
    "div",
    {
      ...
      children: [
        hasHeadings && /* @__PURE__ */ jsxs20(Fragment11, { children: [
          /* @__PURE__ */ jsx29("p", { className: "nx-mb-4 nx-font-semibold nx-tracking-tight", children: renderComponent(config.toc.title) }),
          /* @__PURE__ */ jsx29("ul", { children: items.map(({ id, value, depth }) => {
            var _a2, _b, _c, _d;
            return /* @__PURE__ */ jsx29("li", { className: "nx-my-2 nx-scroll-my-6 nx-scroll-py-6", children: /* @__PURE__ */ jsx29(
              "a",
              {
                href: `#${id}`,
                className: cn19(
        ...
        hasMetaInfo && /* @__PURE__ */ jsxs20(
          "div",
          {
            ...
            children: [
              config.feedback.content ? /* @__PURE__ */ jsx29(
                Anchor,
                {
...
var DEFAULT_THEME = {
  ...
  chat: {
    icon: /* @__PURE__ */ jsxs21(Fragment12, { children: [
      /* @__PURE__ */ jsx31(DiscordIcon, {}),
      /* @__PURE__ */ jsx31("span", { className: "nx-sr-only", children: "Discord" })
    ] })
  },
  darkMode: true,
  direction: "ltr",
  ...
  gitTimestamp: function GitTimestamp({ timestamp }) {
    ...
    return /* @__PURE__ */ jsxs21(Fragment12, { children: [
      "Last updated on",
      " ",
      /* @__PURE__ */ jsx31("time", { dateTime: timestamp.toISOString(), children: timestamp.toLocaleDateString(locale, {
        day: "numeric",
        month: "long",
        year: "numeric"
      }) })
  ...
  head: /* @__PURE__ */ jsxs21(Fragment12, { children: [
    /* @__PURE__ */ jsx31("meta", { name: "msapplication-TileColor", content: "#fff" }),
    /* @__PURE__ */ jsx31("meta", { httpEquiv: "Content-Language", content: "en" }),
    /* @__PURE__ */ jsx31("meta", { name: "description", content: "Nextra: the next docs builder" }),
    /* @__PURE__ */ jsx31("meta", { name: "twitter:card", content: "summary_large_image" }),
    /* @__PURE__ */ jsx31("meta", { name: "twitter:site", content: "@shuding_" }),
    /* @__PURE__ */ jsx31("meta", { property: "og:title", content: "Nextra: the next docs builder" }),
    /* @__PURE__ */ jsx31("meta", { property: "og:description", content: "Nextra: the next docs builder" }),
    /* @__PURE__ */ jsx31("meta", { name: "apple-mobile-web-app-title", content: "Nextra" })
  ] }),
  i18n: [],
  logo: /* @__PURE__ */ jsxs21(Fragment12, { children: [
    /* @__PURE__ */ jsx31("span", { className: "nx-font-extrabold", children: "Nextra" }),
    /* @__PURE__ */ jsx31("span", { className: "nx-ml-2 nx-hidden nx-font-normal nx-text-gray-600 md:nx-inline", children: "The Next Docs Builder" })
  ] }),
  logoLink: true,
  navbar: {
    component: Navbar
  ...
  project: {
    icon: /* @__PURE__ */ jsxs21(Fragment12, { children: [
      ...
      /* @__PURE__ */ jsx31("span", { className: "nx-sr-only", children: "GitHub" })
    ] })
  },
  search: {
    component: function Search2({ className, directories }) {
      const config = useConfig();
      return config.flexsearch ? /* @__PURE__ */ jsx31(Flexsearch, { className }) : /* @__PURE__ */ jsx31(MatchSorterSearch, { className, directories });
    },
    emptyResult: /* @__PURE__ */ jsx31("span", { className: "nx-block nx-select-none nx-p-8 nx-text-center nx-text-sm nx-text-gray-400", children: "No results found." }),
  ...
  sidebar: {
    ...
    titleComponent: ({ title }) => /* @__PURE__ */ jsx31(Fragment12, { children: title }),
    toggleButton: false
  },
  themeSwitch: {
...
function HeadingLink(_a) {
  ...
  return /* @__PURE__ */ jsxs22(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        children,
        /* @__PURE__ */ jsx32("span", { className: "nx-absolute -nx-mt-20", id, ref: obRef }),
        /* @__PURE__ */ jsx32(
          "a",
          {
            href: `#${id}`,
...
var Details = (_a) => {
  ...
  return /* @__PURE__ */ jsxs22(
    ...
    __spreadProps(__spreadValues(__spreadProps(__spreadValues({
      ...
      children: [
        /* @__PURE__ */ jsx32(DetailsProvider, { value: setOpen, children: summary }),
        /* @__PURE__ */ jsx32(Collapse, { isOpen: openState, children: restChildren })
      ]
    })
  );
};
...
var A = (_a) => {
  ...
  return /* @__PURE__ */ jsx32(Anchor, __spreadValues({ href, newWindow: EXTERNAL_HREF_REGEX.test(href) }, props));
};
var getComponents = ({
  isRawLayout,
  components
  ...
  return __spreadValues({
    h1: (props) => /* @__PURE__ */ jsx32(
      "h1",
      __spreadValues({
        className: "nx-mt-2 nx-text-4xl nx-font-bold nx-tracking-tight nx-text-slate-900 dark:nx-text-slate-100"
      }, props)
    ),
    h2: (props) => /* @__PURE__ */ jsx32(HeadingLink, __spreadValues({ tag: "h2", context }, props)),
    h3: (props) => /* @__PURE__ */ jsx32(HeadingLink, __spreadValues({ tag: "h3", context }, props)),
    h4: (props) => /* @__PURE__ */ jsx32(HeadingLink, __spreadValues({ tag: "h4", context }, props)),
    h5: (props) => /* @__PURE__ */ jsx32(HeadingLink, __spreadValues({ tag: "h5", context }, props)),
    h6: (props) => /* @__PURE__ */ jsx32(HeadingLink, __spreadValues({ tag: "h6", context }, props)),
    ul: (props) => /* @__PURE__ */ jsx32(
      "ul",
      __spreadValues({
        className: "nx-mt-6 nx-list-disc first:nx-mt-0 ltr:nx-ml-6 rtl:nx-mr-6"
      }, props)
    ),
    ol: (props) => /* @__PURE__ */ jsx32(
      "ol",
      __spreadValues({
        className: "nx-mt-6 nx-list-decimal first:nx-mt-0 ltr:nx-ml-6 rtl:nx-mr-6"
      }, props)
    ),
    li: (props) => /* @__PURE__ */ jsx32("li", __spreadValues({ className: "nx-my-2" }, props)),
    blockquote: (props) => /* @__PURE__ */ jsx32(
      "blockquote",
      __spreadValues({
        className: cn20(
    ...
    hr: (props) => /* @__PURE__ */ jsx32("hr", __spreadValues({ className: "nx-my-8 dark:nx-border-gray-900" }, props)),
    a: Link,
    table: (props) => /* @__PURE__ */ jsx32(
      Table,
      __spreadValues({
        className: "nextra-scrollbar nx-mt-6 nx-p-0 first:nx-mt-0"
      }, props)
    ),
    p: (props) => /* @__PURE__ */ jsx32("p", __spreadValues({ className: "nx-mt-6 nx-leading-7 first:nx-mt-0" }, props)),
    tr: Tr,
    th: Th,
    td: Td,
    details: Details,
...
var classes6 = {
  ...
  main: cn21("nx-w-full nx-break-words")
};
var Body = ({
  themeContext,
  breadcrumb,
  ...
  if (themeContext.layout === "raw") {
    return /* @__PURE__ */ jsx33("div", { className: classes6.main, children });
  }
  const date = themeContext.timestamp && config.gitTimestamp && timestamp ? new Date(timestamp) : null;
  const gitTimestampEl = (
    // Because a user's time zone may be different from the server page
    mounted && date ? /* @__PURE__ */ jsx33("div", { className: "nx-mt-12 nx-mb-8 nx-block nx-text-xs nx-text-gray-500 ltr:nx-text-right rtl:nx-text-left dark:nx-text-gray-400", children: renderComponent(config.gitTimestamp, { timestamp: date }) }) : /* @__PURE__ */ jsx33("div", { className: "nx-mt-16" })
  );
  const content = /* @__PURE__ */ jsxs23(Fragment13, { children: [
    children,
    gitTimestampEl,
    navigation
  ] });
  ...
  return /* @__PURE__ */ jsx33(
    "article",
    {
      ...
      children: /* @__PURE__ */ jsxs23("main", { className: "nx-w-full nx-min-w-0 nx-max-w-6xl nx-px-6 nx-pt-4 md:nx-px-12", children: [
        breadcrumb,
        body
      ] })
    }
...
var InnerLayout = ({
  ...
  const tocEl = activeType === "page" || !themeContext.toc || themeContext.layout !== "default" ? themeContext.layout !== "full" && themeContext.layout !== "raw" && /* @__PURE__ */ jsx33("nav", { className: classes6.toc, "aria-label": "table of contents" }) : /* @__PURE__ */ jsx33(
    "nav",
    {
      className: cn21(classes6.toc, "nx-px-4"),
  ...
  return (
    ...
    // `html` element.
    /* @__PURE__ */ jsxs23("div", { dir: direction, children: [
      /* @__PURE__ */ jsx33(
        "script",
        {
      ...
      /* @__PURE__ */ jsx33(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsxs23(ActiveAnchorProvider, { children: [
            /* @__PURE__ */ jsx33(
              Sidebar,
              {
                docsDirectories,
            ...
            tocEl,
            /* @__PURE__ */ jsx33(SkipNavContent, {}),
            /* @__PURE__ */ jsx33(
              Body,
              {
                themeContext,
                breadcrumb: activeType !== "page" && themeContext.breadcrumb ? /* @__PURE__ */ jsx33(Breadcrumb, { activePath }) : null,
                timestamp,
                navigation: activeType !== "page" && themeContext.pagination ? /* @__PURE__ */ jsx33(
                  NavLinks,
                  {
...
function Layout(_a) {
  ...
  return /* @__PURE__ */ jsx33(ConfigProvider, { value: context, children: /* @__PURE__ */ jsx33(InnerLayout, __spreadProps(__spreadValues({}, context.pageOpts), { children })) });
}
export {
  Bleed,
  Callout,
